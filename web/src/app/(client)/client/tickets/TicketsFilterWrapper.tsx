    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px", marginBottom: "24px" }}>
      ...
      <div className="search-bar-row" style={{ display: "flex", gap: "12px", alignItems: "center", flexWrap: "wrap" }}>
        ...
        <button
          ...
          aria-controls="client-ticket-adv-filters"
        >
      ...
      {showAdv && (
        ...
        >
          <div className="form-group">
            <label className="form-label" htmlFor="ctf-status">Status</label>
            <select
              id="ctf-status"
              className="input"
              value={localStatus}
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="ctf-type">Typ zgłoszenia</label>
            <select
              id="ctf-type"
              className="input"
              value={localType}
          ...
          {role === "CLIENT_HEAD" && branches.length > 0 && (
            <div className="form-group">
              <label className="form-label" htmlFor="ctf-branch">Oddział</label>
              <select
                id="ctf-branch"
                className="input"
                value={localBranchId}
